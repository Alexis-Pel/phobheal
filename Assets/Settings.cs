...
public static class Settings
{
    ...
    public static string experienceInstruction = "N'oubliez pas que vous avez le contrôle total de l'expérience. à tout moment, vous pouvez faire une pause ou arréter la session. Votre bien-être est notre priorité.\r\n\r\nNous espérons que Phobheal vous aidera à surmonter vos phobies et à retrouver une vie plus libre et sereine.";
}
